...
SRC = main.cpp server/Server.cpp commands/Command.cpp commands/Join.cpp client/Client.cpp channel/Channel.cpp commands/Nick.cpp commands/Who.cpp commands/PrivMSG.cpp
